...
{
    public class RefreshPasswordViewModel
    {
        ...
        [DisplayName("Şifre Tekrar"), Required(ErrorMessage = "{0} alanı boş geçilemez"), DataType(DataType.Password), StringLength(50, ErrorMessage =
           "{0} max. {1}  karater olmalı")]
